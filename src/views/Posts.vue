        ...
        <div class="card">
          <div class="card-header">
            <ul class="nav nav-pills nav-justified">
              <li class="nav-item">
                <a class="nav-link" href="#" v-on:click="showCohortPosts()">Cohort Posts</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" v-on:click="showAllPosts()">All Posts</a>
              </li>
            </ul>
          </div>
          <div class="card-body">
            <button class="btn btn-lg btn-vuejs w-100" data-toggle="collapse" href="#newPost" role="button" aria-expanded="false" aria-controls="newPost" v-on:click="showCreatePost = !showCreatePost">
...
export default {
  ...
  created: function() {
    ...
    axios.get("http://localhost:3000/api/posts", {params}).then(response => {
